...
<html lang="es">
    ...
    <ul class="side-nav fixed" id="mobile-menu">
            ...
            <div class="row">
                ...
                <div class="col col s8 m8 l8 ">
                    ...
                    <ul id="profile-dropdown" class="dropdown-content">
                        ...
                        <li class="divider"></li>
                        <li><a href="#"><i class="user-icons material-icons">input</i> Salir</a>
                        </li>
                    </ul>
                    <a class="btn-flat dropdown-button waves-effect waves-light white-text profile-btn"  data-activates="profile-dropdown">John Doe<i class="tiny material-icons right">settings</i></a>
     ...
     <!--   <li class="bold"><i class="material-icons iconos-menu">contacts</i><a class="collapsible-header  waves-effect waves-teal">Proveedores</a> 
    ...
    <footer class="page-footer black">
        ...
        <div class="footer-copyright">
            <div class="container">
                © 2016 Copyright Autos Flash.
                <a class="grey-text text-lighten-4 right" href="#!">
                    <img src="../img/logo/logo.png " width="70px">
                </a>
            </div>
        </div>
    </footer>
