...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-05-2017 a las 22:04:05
...
CREATE TABLE `facturas` (
  ...
  `codigo_reservacion` int(11) UNSIGNED NOT NULL,
...
CREATE TABLE `fotos_vehiculos` (
  ...
  `url_foto` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `preguntas_usuarios` (
  `codigo_pregunta` int(11) UNSIGNED NOT NULL,
  `pregunta_usuario` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `preguntas_usuarios` (`codigo_pregunta`, `pregunta_usuario`) VALUES
(1, '¿Cual es el nombre de mi primer mascota?');
...
CREATE TABLE `usuarios` (
  ...
  `codigo_cargo` int(11) UNSIGNED NOT NULL,
  `url_foto` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `codigo_pregunta` int(11) UNSIGNED NOT NULL,
  `respuesta_usuario` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `usuarios` (`codigo_usuario`, `nombre_usuario`, `apellido_usuario`, `correo_usuario`, `usuario`, `contrasenia_usuario`, `fecha_nacimiento`, `codigo_cargo`, `url_foto`, `codigo_pregunta`, `respuesta_usuario`, `estado_usuario`) VALUES
(2, 'Francisco', 'Ganuza', 'franganuza@hotmail.com', 'root', '$2y$10$gkTsHM0knBmSjskOqzaADe2FDgxYUFRzWHTTpf10vKEPCdsLIu9sO', '1999-04-06', 1, NULL, 1, 'Hachi', 1);
...
CREATE TABLE `vehiculos` (
  `codigo_vehiculo` int(11) UNSIGNED NOT NULL,
  `nombre__vehiculo` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `estado` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT 'activo',
  `codigo_modelo` int(11) UNSIGNED NOT NULL,
...
ALTER TABLE `fotos_vehiculos`
  ...
  ADD UNIQUE KEY `url_foto` (`url_foto`),
...
ALTER TABLE `preguntas_usuarios`
  ...
  ADD UNIQUE KEY `pregunta_usuario` (`pregunta_usuario`);
...
ALTER TABLE `usuarios`
  ...
  ADD KEY `codigo_pregunta` (`codigo_pregunta`),
  ADD KEY `codigo_pregunta_2` (`codigo_pregunta`),
...
ALTER TABLE `vehiculos`
  ...
  ADD UNIQUE KEY `nombre__vehiculo` (`nombre__vehiculo`),
...
--
ALTER TABLE `clientes`
  MODIFY `codigo_cliente` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `comentarios`
--
ALTER TABLE `comentarios`
  MODIFY `codigo_comentario` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `facturas`
--
ALTER TABLE `facturas`
  MODIFY `codigo_factura` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `fotos_vehiculos`
--
ALTER TABLE `fotos_vehiculos`
  MODIFY `codigo_foto` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `marcas`
--
ALTER TABLE `marcas`
  MODIFY `codigo_marca` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `modelos`
--
ALTER TABLE `modelos`
  MODIFY `codigo_modelo` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `preguntas_usuarios`
--
ALTER TABLE `preguntas_usuarios`
  MODIFY `codigo_pregunta` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `proveedores`
--
ALTER TABLE `proveedores`
  MODIFY `codigo_proveedor` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `series`
  MODIFY `codigo_serie` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `tipos_fotos`
--
ALTER TABLE `tipos_fotos`
  MODIFY `codigo_tipo_foto` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `tipos_vehiculos`
--
ALTER TABLE `tipos_vehiculos`
  MODIFY `codigo_tipo_vehiculo` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `usuarios`
--
ALTER TABLE `usuarios`
  MODIFY `codigo_usuario` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `vehiculos`
  MODIFY `codigo_vehiculo` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `facturas`
  ...
  ADD CONSTRAINT `facturas_ibfk_3` FOREIGN KEY (`codigo_reservacion`) REFERENCES `reservaciones` (`codigo_reserva`);
...
--
ALTER TABLE `reservaciones`
  ADD CONSTRAINT `reservaciones_ibfk_1` FOREIGN KEY (`codigo_cliente`) REFERENCES `clientes` (`codigo_cliente`) ON UPDATE CASCADE,
...
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `usuarios_ibfk_1` FOREIGN KEY (`codigo_pregunta`) REFERENCES `preguntas_usuarios` (`codigo_pregunta`) ON UPDATE CASCADE,
